<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/SinavMain.Master" AutoEventWireup="true" CodeBehind="Sinav.aspx.cs" Inherits="BiSinavProject.PL.SinavBestebes.Sinav" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated fadeInDown">
                ...
                <div class="modal-body">
                    <p>
                        <strong>"Beşte Beş" yapmaya hazır mısın?</strong>
                    </p>
                </div>
                <div class="modal-footer">
                    ...
                    <button runat="server" id="ButtonSinavaBasla" class="btn btn-info btn-large" type="submit" onserverclick="ButtonSinavaBasla_Click"><i class="fa fa-check"></i>Başla</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <table class="table no-margins">
                        <tbody>
                            ...
                            <tr class="text-center">
                                <td colspan="2">
                                    <button runat="server" id="ButtonYeniSinav" type="button" class="btn btn-success btn-lg" onserverclick="ButtonYeniSinav_Click"><i class="fa fa-refresh"></i>&nbsp;&nbsp;Yeni Sınav</button>
                                </td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="2">
    ...
    <script type="text/javascript">
        ...
        function myTimer() {
            ...
            if (labelDurum.value == "SinavAktif") {
                ...
                var diff = sunucuZaman.getTime() - baslangicZaman.getTime();
                var fark = sunucuZaman.getTime() - baslangicZaman.getTime();
