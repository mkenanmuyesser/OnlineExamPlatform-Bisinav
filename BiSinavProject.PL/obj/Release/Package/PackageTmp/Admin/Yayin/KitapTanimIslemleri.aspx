<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="KitapTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Yayin.KitapTanimIslemleri" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderHead" runat="server">
    <script type="text/javascript">
        ...
        function OnListBoxKategorilerSelectionChanged(listBox, args) {
            if (args.index == 0)
        ...
        function UpdateSelectAllItemState() {
            IsAllSelected() ? ListBoxKategoriler.SelectIndices([0]) : ListBoxKategoriler.UnselectIndices([0]);
        }

        function IsAllSelected() {
            var selectedDataItemCount = ListBoxKategoriler.GetItemCount() - (ListBoxKategoriler.GetItem(0).selected ? 0 : 1);
            return ListBoxKategoriler.GetSelectedItems().length == selectedDataItemCount;
        }

        function UpdateText() {
            var selectedItems = ListBoxKategoriler.GetSelectedItems();
            DropDownEditKategoriler.SetText(GetSelectedItemsText(selectedItems));
        }

        function SynchronizeListBoxKategorilerValues(dropDown, args) {
            ListBoxKategoriler.UnselectAll();
            var texts = dropDown.GetText().split(textSeparator);
            var values = GetValuesByTexts(texts);
            ListBoxKategoriler.SelectValues(values);
            UpdateSelectAllItemState();
            UpdateText();
        }
        ...
        function GetValuesByTexts(texts) {
            ...
            for (var i = 0; i < texts.length; i++) {
                item = ListBoxKategoriler.FindItemByText(texts[i]);
                if (item != null)
        ...
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Kategoriler : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxDropDownEdit ID="DropDownEditKategoriler" ClientInstanceName="DropDownEditKategoriler" Width="200px" runat="server" AnimationType="None">
                        <DropDownWindowStyle BackColor="#EDEDED" />
                        <DropDownWindowTemplate>
                            <dx:ASPxListBox ID="ListBoxKategoriler" ClientInstanceName="ListBoxKategoriler" runat="server" SelectionMode="CheckColumn"
                                ValueType="System.Int32" TextField="Adi" ValueField="KategoriKey" Width="100%">
                                <Border BorderStyle="None" />
                                <BorderBottom BorderStyle="Solid" BorderWidth="1px" BorderColor="#DCDCDC" />
                                <ClientSideEvents SelectedIndexChanged="OnListBoxKategorilerSelectionChanged" />
                            </dx:ASPxListBox>
                            <table style="width: 100%">
                                <tr>
                                    <td style="padding: 4px">
                                        <dx:ASPxButton AutoPostBack="False" runat="server" Text="X" Style="float: right">
                                            <ClientSideEvents Click="function(s, e){ DropDownEditKategoriler.HideDropDown(); }" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
                        </DropDownWindowTemplate>
                        <ClientSideEvents TextChanged="SynchronizeListBoxKategorilerValues" DropDown="SynchronizeListBoxKategorilerValues" />
                    </dx:ASPxDropDownEdit>
                </td>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Kitap Adı : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxKitapAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxSpinEdit ID="SpinEditKitapSiralama" runat="server" DecimalPlaces="0" Width="200px" Font-Size="Small" MaxLength="4" NumberType="Integer" AllowNull="false" MinValue="0" MaxValue="9999" SpinButtons-ShowIncrementButtons="false">
                    </dx:ASPxSpinEdit>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewKitapTanim" runat="server" KeyFieldName="KitapKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewKitapTanim_RowDeleting" OnCustomButtonCallback="GridViewKitapTanim_CustomButtonCallback">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="Adi" Caption="Kitap Adı">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="Kategoriler" Caption="Kategoriler">
                                <HeaderStyle HorizontalAlign="Center" />
                            </dx:GridViewDataTextColumn>
