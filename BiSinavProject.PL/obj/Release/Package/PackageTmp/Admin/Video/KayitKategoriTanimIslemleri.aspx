<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="KayitKategoriTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Yayin.KayitKategoriTanimIslemleri" %>
        ...
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Kayıt Kategori Adı : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxKayitKategoriAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxSpinEdit ID="SpinEditKayitKategoriSiralama" runat="server" DecimalPlaces="0" Width="200px" Font-Size="Small" MaxLength="4" NumberType="Integer" AllowNull="false" MinValue="0" MaxValue="9999" SpinButtons-ShowIncrementButtons="false">
                    </dx:ASPxSpinEdit>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewKayitKategoriTanim" runat="server" KeyFieldName="KayitKategoriKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewKayitKategoriTanim_RowDeleting" OnCustomButtonCallback="GridViewKayitKategoriTanim_CustomButtonCallback">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="Adi" Caption="Kayıt Kategori Adı">
