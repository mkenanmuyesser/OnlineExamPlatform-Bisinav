<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="IcerikTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Haber.IcerikTanimIslemleri" %>
        ...
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxAciklama" runat="server" Width="200px" Font-Size="Small" MaxLength="200">
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxDateEdit ID="DateEditTarih" runat="server" Width="200px" Font-Size="Small" DisplayFormatString="dd.MM.yyyy" EditFormatString="dd.MM.yyyy" >
                        <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                            <RequiredField ErrorText=" " IsRequired="true" />
                        </ValidationSettings>
                    </dx:ASPxDateEdit>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewTanim" runat="server" KeyFieldName="IcerikKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewTanim_RowDeleting" OnCustomButtonCallback="GridViewTanim_CustomButtonCallback">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="Aciklama" Caption="Açıklama">
                              ...
                              <dx:GridViewDataTextColumn FieldName="Tarih" Caption="Tarih" PropertiesTextEdit-DisplayFormatString="dd.MM.yyyy HH:mm">
