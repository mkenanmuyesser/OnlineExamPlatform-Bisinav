<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="AlanTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Sinav.AlanTanimIslemleri" %>
        ...
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxAlanAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewAlanTanim" runat="server" KeyFieldName="AlanKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewAlanTanim_RowDeleting" OnCustomButtonCallback="GridViewAlanTanim_CustomButtonCallback">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="Adi" Caption="Alan Adı">
