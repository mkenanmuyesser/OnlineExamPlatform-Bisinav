...
{
    public partial class MansetTanimIslemleri : System.Web.UI.Page
    {
        ...
        private const string PageUrl = "MansetTanimIslemleri.aspx";
        private const string PageHeader = "Manşet Tanım İşlemleri";
        ...
        protected void ButtonKaydetGuncelle_Click(object sender, EventArgs e)
        {
            ...
            using (var service = new DBEntities())
            {
                ...
                {
                    data = service.Mansets.SingleOrDefault(p => p.MansetKey == Key);
                    if (data == null)
                    {
        ...
        protected void GridViewTanim_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            using (var service = new DBEntities())
            {
                ...
                Manset deleteddata = service.Mansets.Single(p => p.MansetKey == deletedkey);
                service.Mansets.Remove(deleteddata);
        ...
        protected void GridViewTanim_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            ...
            int key = Convert.ToInt32(GridViewTanim.GetRowValues(index, new string[] { "MansetKey" }));
        ...
        private void DataLoad()
        {
            using (var service = new DBEntities())
            {
                ...
                GridViewTanim.DataSource = service.Mansets.
                                                   AsNoTracking().
                                                   OrderBy(p => p.Sira).
                                                   ToList();
                ...
                if (Key != 0 && !IsPostBack)
                {
                    Manset data = service.Mansets.
                                       AsNoTracking().
                                       Single(p => p.MansetKey == Key);
