<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="MansetTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Haber.MansetTanimIslemleri" %>
    ...
    <div style="width: 100%;">
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Resim : (520x327)" Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewTanim" runat="server" KeyFieldName="MansetKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewTanim_RowDeleting" OnCustomButtonCallback="GridViewTanim_CustomButtonCallback">
