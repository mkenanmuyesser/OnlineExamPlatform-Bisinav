<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="DersTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Sinav.DersTanimIslemleri" %>
    ...
    <div style="width: 100%;">
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxDersAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
                        <ValidationSettings ValidationGroup="KayitGuncelle" Display="Dynamic">
                            <RequiredField ErrorText=" " IsRequired="true" />
                        </ValidationSettings>
                    </dx:ASPxTextBox>
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewDersTanim" runat="server" KeyFieldName="DersKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewDersTanim_RowDeleting" OnCustomButtonCallback="GridViewDersTanim_CustomButtonCallback">
