<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="EDergiTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Yayin.EDergiTanimIslemleri" %>
        ...
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="E-Dergi Adı : " Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxTextBox ID="TextBoxEDergiAdi" runat="server" Width="200px" Font-Size="Small" MaxLength="50">
            ...
            <tr>
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Resim : (250x360)" Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewEDergiTanim" runat="server" KeyFieldName="EDergiKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewEDergiTanim_RowDeleting" OnCustomButtonCallback="GridViewEDergiTanim_CustomButtonCallback">
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="Adi" Caption="E-Dergi Adı">
                            ...
                            <dx:GridViewCommandColumn Caption="İşlemler" ButtonType="Image">
                                <CustomButtons>
                                    <dx:GridViewCommandColumnCustomButton ID="ButtonDetay" Visibility="AllDataRows" Image-ToolTip="Düzenle" Image-Url="../../../Content/Images/Icons/edit.png" Image-Width="24" Image-Height="24">
                                    </dx:GridViewCommandColumnCustomButton>
                                    <dx:GridViewCommandColumnCustomButton ID="ButtonGoster" Visibility="AllDataRows" Image-ToolTip="Göster" Image-Url="../../../Content/Images/Icons/detail.png" Image-Width="24" Image-Height="24">
                                    </dx:GridViewCommandColumnCustomButton>
                                </CustomButtons>
