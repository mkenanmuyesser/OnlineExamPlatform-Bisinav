<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMain.master" AutoEventWireup="true" CodeBehind="EDergiSayfaTanimIslemleri.aspx.cs" Inherits="BiSinavProject.PL.Program.Yayin.EDergiSayfaTanimIslemleri" %>
        ...
        <table style="border-color: #999999; width: 100%;" border="1">
            ...
            <tr>
                ...
                <td class="TdSag" style="width: 35%;">
                    <dx:ASPxComboBox ID="ComboBoxEDergiAdi" runat="server" ValueType="System.Int32" Width="200px" Font-Size="Small" TextField="Adi" ValueField="EDergiKey">
            ...
            <tr>
                ...
                <td class="TdSol" style="width: 15%;">
                    <dx:ASPxLabel runat="server" Text="Resim : Min(1115x1443)" Font-Size="Small" ForeColor="Red" />
                </td>
                <td class="TdSag" style="width: 35%;">
            ...
            <tr>
                <td class="TdOrtala" colspan="4">
                    <dx:ASPxGridView ID="GridViewEDergiSayfaTanim" runat="server" KeyFieldName="EDergiSayfaKey" AutoGenerateColumns="false" Width="100%" EnableCallBacks="true" Font-Size="Small" OnRowDeleting="GridViewEDergiSayfaTanim_RowDeleting" OnCustomButtonCallback="GridViewEDergiSayfaTanim_CustomButtonCallback">
                        ...
                        <SettingsBehavior AllowDragDrop="false" AllowFocusedRow="false" ConfirmDelete="true" AutoExpandAllGroups="false" />
                        <SettingsPager Visible="true" PageSize="15" AlwaysShowPager="true" Position="Bottom" ShowEmptyDataRows="true" />
                        <Paddings Padding="0px" />
                        <Border BorderWidth="0px" />
                        <BorderBottom BorderWidth="1px" />
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="EDergi.Adi" Caption="E-Dergi Adı">
